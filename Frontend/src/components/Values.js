        ...
        <div className='bg-[#28509E] pt-[40px] sm:pt-[40px] md:pt-[60px] pb-[90px]' id='values'>
            ...
            <div className='grid grid-cols-1 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 place-items-start gap-x-4 px-[20px] md:px-[50px] sm:px-[100px] mb-[20px] gap-y-6 lg:gap-y-10'>
                <div className='h-full flex justify-center items-start md:items-center flex-col w-full bg-[#F7F7F7] p-[20px] md:p-[40px] xl:px-[50px] rounded-[20px]'>
                    <motion.img animate={{ rotate: 360 }} transition={{ type: "spring", duration: 5, bounce: 0.6, repeat: Infinity }} src={publicAsset("/assets/reliability.png")} alt='serviceIcon' className='w-[60px] xl:w-[90px] mb-[10px]' />
                ...
                <div className='h-full flex justify-center items-start md:items-center flex-col w-full bg-[#F7F7F7] p-[20px] md:p-[40px] xl:px-[50px] rounded-[20px]'>
                    <motion.img animate={{ rotate: 360 }} transition={{ type: "spring", duration: 5, bounce: 0.6, repeat: Infinity }} src={publicAsset("/assets/target.png")} alt='serviceIcon' className='w-[60px] xl:w-[90px] mb-[10px]' />
                    <div className='flex flex-row justify-center items-center mb-[20px]'>
                ...
                <div className='h-full flex justify-center items-start md:items-center flex-col w-full bg-[#F7F7F7] p-[20px] md:p-[40px] xl:px-[50px] rounded-[20px]'>
                    <motion.img animate={{ rotate: 360 }} transition={{ type: "spring", duration: 5, bounce: 0.6, repeat: Infinity }} src={publicAsset("/assets/innovation.png")} alt='serviceIcon' className='w-[60px] xl:w-[90px] mb-[10px]' />
                    <div className='flex flex-row justify-center items-center mb-[20px]'>
                ...
                <div className='h-full flex justify-center items-start md:items-center flex-col w-full md:flex sm:flex bg-[#F7F7F7] p-[20px] md:p-[40px] xl:px-[50px] rounded-[20px]'>
                    <motion.img animate={{ rotate: 360 }} transition={{ type: "spring", duration: 5, bounce: 0.6, repeat: Infinity }} src={publicAsset("/assets/collaboration.png")} alt='serviceIcon' className='w-[60px] xl:w-[90px] mb-[10px]' />
                    <div className='flex flex-row justify-center items-center mb-[20px]'>
                ...
                <div className='h-full flex justify-center items-start md:items-center flex-col w-full md:flex sm:flex bg-[#F7F7F7] p-[20px] md:p-[40px] xl:px-[50px] rounded-[20px]'>
                    <motion.img animate={{ rotate: 360 }} transition={{ type: "spring", duration: 5, bounce: 0.6, repeat: Infinity }} src={publicAsset("/assets/diver.png")} alt='serviceIcon' className='w-[60px] xl:w-[90px] mb-[10px]' />
                    <div className='flex flex-row justify-center items-center mb-[20px]'>
